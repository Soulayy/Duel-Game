...
class Vegeta {
    ...
    kikodan(ennemi) {
        ...
        ennemi.pv = ennemi.pv - 250 + (250 /100 * 20)
        console.log(`il rest a ${ennemi.nom} => ${ennemi.pv}`);
        moveG(ennemi.pv / 1400 * 100)
    }
    ...
    finalKameHaMeHa(ennemi) {
        ...
        ennemi.pv = ennemi.pv - 250 + (250 /100 * 40)  
        console.log(`il rest a ${ennemi.nom} => ${ennemi.pv}`);
        moveG(ennemi.pv / 1400 * 100)
    }

    ultimateFusion(ennemi) {
        ennemi.pv = ennemi.pv - 250 + (250 /100 * 60)  
        console.log(`il rest a ${ennemi.nom} => ${ennemi.pv}`);
        moveG(ennemi.pv / 1400 * 100)
    }
}

let vegeta = new Vegeta ("Vegeta", 250, 1600)
...
let imgvegeta = document.getElementById("poseF")
let imgvegetaBlue = document.getElementById("poseGF")
